...
export async function generateMetadata() {
  ...
  const description =
    "Современная стоматологическая клиника в Кемерово. Лечение кариеса, протезирование, отбеливание. Опытные врачи, безболезненное лечение, исправление прикуса и рентгенодиагностика";
  const keywords =
